      ...
      <div className="flex flex-col gap-12 sm:flex sm:flex-row sm:gap-12 items-start  mt-12 sm:mt-24">
        <div className="w-full sm:full flex flex-col gap-4">
          ...
          <p className="text-md sm:text-lg text-paragrafo leading-6  font-font2">
            ...
            joguei, "The Witcher 3" se destaca como meu favorito absoluto,
            graças ao seu enredo cativante, personagens memoráveis e um mundo
            aberto vasto e detalhado. Atualmente, jogo exclusivamente no PC,
            onde posso aproveitar a melhor qualidade gráfica e uma vasta
